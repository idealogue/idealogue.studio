        ...
        <Layout theme={LayoutTheme}>
            ...
            <Topic title="From Engi.works to Vizor">
                <Section theme={NavyTheme} head>
                    ...
                    <Container>
                        <p>
                            The app we saw in mid-2015, then known as Engi, was
                            very rough, but powerful. It had its own WebGL-based
                            realtime 3D graphics engine, a ton of shaders and
                            effects, the ability to output to stereo VR views,
                            and a deep visual programming interface. We renamed
                            it Vizor and created a new brand style for it.
                        </p>
                        <Spacer head>
                ...
                <Section theme={NavyTheme} head>
                    ...
                    <Container>
                        <p>
                            ...
                            programming UI. It could do almost anything, but was
                            a confusing mess of tiny icons, unclear connections
                            and hard to fathom structure. We introduced a colour
                            scheme for patch types, accordions, clearer
                            connections, and a consistent structure.
                        </p>
                        <Spacer head>
                            <Modules />
                        </Spacer>
            ...
            <Topic title="The Patches Editor">
                <Section theme={NavyTheme} head tail>
                    ...
                    <Container>
                        <p>
                            The visual programming editor, now renamed Patches
                            and open-source, is a fast and fluid webGL-based 3D
                            editor with switchable cameras and single-click to
                            publish. We introduced a unique circular grid
                            centred around the user, for easy VR composing, as
                            well as bold, highly visible icons for HMD and
                            lights.
                        </p>
                        <Spacer head>
            ...
            <Topic title="The Player">
                <Section theme={MidnightBlueTheme} head tail>
                    ...
                    <Container>
                        <p>
                            Content on Vizor ranges from 360 photos to immersive
                            stories, infographics and visual experiments. The
                            player was designed for simplicity across 2D and VR
                            views on desktops and mobile.
                        </p>
                    </Container>
                    <Spacer head>
                        <PlayerPics />
            ...
            <Topic title="User Pages">
                <Section theme={NavyTheme} head tail>
                    ...
                    <Container>
                        <p>
                            With a fully web-based file system, users needed to
                            be able to have public and private views of their
                            projects, along with drafts and public projects to
                            keep things tidy. We prototyped and created this
                            from the ground up, as it didn&apos;t exist in the
                            original prototype.
                        </p>
                        <Spacer head>
                            <BrowserFrame shadow dark>
                ...
                <Section theme={DarkBlueTheme} head tail>
                    ...
                    <Container>
                        <p>
                            ...
                            worked with illustrator Jeremy Edelblut to develop a
                            playful, low-poly style to use across 3D icons for
                            the editor, as well as library assets for users to
                            build with.
                        </p>
                    </Container>
                    <Spacer head>
            ...
            <Topic title="Vizor 360">
                <Section theme={NavyTheme} head>
                    ...
                    <Container>
                        <p>
                            The Patches editor is powerful, but seeing strong
                            user interest in 360 media led to building a new,
                            user-friendly app for telling stories and making
                            tours with 360 images. Built from scratch in React,
                            Vizor 360 is fast, light and easy to use.
                        </p>
                        <Spacer head>
                            <BrowserFrame shadow dark>
                                <FluidImage
