...
const UnstyledSlide = ({ poster, current, previous, ...props }) => (
    <div {...props} />
)
...
const Slide = styled(UnstyledSlide)`
    ...
    ${({ poster, current, previous }) => !poster && css`
        left: 0;
        opacity: 0;
        position: absolute;
        top: 0;
    ...
    return (
        <div {...props}>
            ...
            <svg viewBox="0 0 320 61" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" fillRule="evenodd">
                    <path d="M0 0v18c0 23.874 19.177 43 43 43h235c23.945 0 42-19.126 42-43V0H0z" fill="#D5D5D5"/>
