...
import { LG, MD, TABLET, font } from '~/utils/css'
            ...
            <Layout rootCss={layoutCss}>
                    ...
                    <Section spacerProps={{ head: true, tail: true }} css={defaultCss}>
                        ...
                        <Container>
                            <p>
                                ...
                                coffee machines. I&nbsp;followed Decent for years as I loved their
                                aim of making great software-controlled espresso, and bought one
                                when I could finally afford it. Unfortunately, what I discovered was
                                poorly written, hobbyist-level software with little care or
                                understanding of typography, interaction design or modern web
                                standards. And it only&nbsp;ran on Android tablets.
                            </p>
                            <p>
                                So I teamed up with Mariusz to make a replacement, mainly because I
                                couldn&apos;t stand to use such unhappy software on such&nbsp;a
                                generally nice espresso machine.
                            </p>
                            <p>
                                ...
                                modes, to match the black or white only options that&nbsp;the
                                machines come in.
                            </p>
                        </Container>
                    </Section>
                ...
                <Topic title="Try it out yourself">
                    <Section spacerProps={{ head: true, tail: true }} css={defaultCss}>
                        ...
                        <Container>
                            <p>
                                The app is still a work in progress. We aim&nbsp;to&nbsp;get the
                                server component running on&nbsp;Raspberry Pi so I can just put it
                                in a cupboard & forget about it, but at the moment it is still a
                                Node app on my MacBook. So making coffee requires some&nbsp;NPM
                                terminal commands 🤓💥
                            </p>
                            <p>
