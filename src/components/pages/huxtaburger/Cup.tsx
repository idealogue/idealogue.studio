...
export function Milkshake(props: React.HTMLAttributes<HTMLDivElement>) {
    return (
        <Cup {...props}>
...
export function Icecream(props: React.HTMLAttributes<HTMLDivElement>) {
    return (
        <Cup {...props}>
...
export function Chips(props: React.HTMLAttributes<HTMLDivElement>) {
    return (
        <Cup {...props}>
