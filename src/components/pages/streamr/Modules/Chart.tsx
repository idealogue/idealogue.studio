...
import { Module, ModuleProps, Body as PrestyledBody } from './Module'

export function Chart({ title = 'Chart', ...props }: Omit<ModuleProps, 'ins'>) {
    return (
        <Module {...props} title={title} ins={[['in1']]}>
            <Body>
                <RangeSelector>
...
const Body = styled(PrestyledBody)`
    color: #adadad;
    font-size: 10px;
